...
--
-- Host: 127.0.0.1    Database: manufacturer_db
-- ------------------------------------------------------
...
INSERT INTO `cars` VALUES (1,'BMW X5',1,0),(2,'Toyota Corolla',2,0);
...
LOCK TABLES `cars_drivers` WRITE;
/*!40000 ALTER TABLE `cars_drivers` DISABLE KEYS */;
INSERT INTO `cars_drivers` VALUES (1,1),(2,2);
/*!40000 ALTER TABLE `cars_drivers` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `drivers` VALUES ('Bob',1,'12345',0),('Alice',2,'67890',0);
...
INSERT INTO `manufacturers` VALUES ('BMW',1,'Germany',0),('Toyota',2,'Japan',0);
...
-- Dump completed on 2021-05-11 18:02:27
