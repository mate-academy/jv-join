...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Manufacturer manufacturerBmwCorp = new Manufacturer("BmwCorp", "Germany");
        manufacturerService.create(manufacturerBmwCorp);
        ...
        carBmv.setManufacturer(manufacturerBmwCorp);
