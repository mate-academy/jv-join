...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //create
        Driver bob = driverService.get(6L);
        Driver alice = driverService.get(4L);
        Car car = new Car();
        ...
        System.out.println(carService.get(5L));
        //add driver to car
        Car tesla = carService.get(1L);
        System.out.println(tesla);
        carService.addDriverToCar(bob, tesla);
        System.out.println(tesla);
        System.out.println(carService.get(1L));
        //remove driver from car
        carService.removeDriverFromCar(max, tesla);
        System.out.println(tesla);
        System.out.println(carService.get(1L));
