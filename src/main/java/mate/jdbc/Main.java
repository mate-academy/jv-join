...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        car1.setDrivers(List.of(driverService.get(1L), driverService.get(2L)));
        ...
        car2.setDrivers(List.of(driverService.get(2L), driverService.get(3L)));
        ...
        car3.setDrivers(List.of(driverService.get(2L),
