...
CREATE TABLE `cars_drivers` (
                              `car_id` bigint DEFAULT NOT NULL,
                              `driver_id` bigint DEFAULT NOT NULL,
                              KEY `cars_drivers_fk` (`cars_id`),
                              KEY `drivers_cars_fk` (`drivers_id`),
                              CONSTRAINT `cars_drivers_fk` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`),
                              CONSTRAINT `drivers_cars_fk` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`id`)
                            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
